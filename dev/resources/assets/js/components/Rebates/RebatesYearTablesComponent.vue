        ...
        data() {
            return {
                ...
                table_fields: [
                    ...
                    (this.is_bank_level ? { key: 'bank', label: 'Bank', tdClass:'text-right', thClass:'text-right' } : {}),
                    { key: 'role', label: (this.is_bank_level ? 'Their Role' : 'Your Role'), tdClass:'text-right', thClass:'text-right' },
                    { key: 'rebate', label: 'Rebate', tdClass:'text-right', thClass:'text-right' },
                ],
                table_data:{},
            };
        },
