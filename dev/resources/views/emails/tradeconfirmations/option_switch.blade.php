...
###Option
@include('emails.tradeconfirmations.emails.tradeconfirmations.partials.option_groups', ['trade_confirmation' => $trade_confirmation])

###Futures
@include('emails.tradeconfirmations.emails.tradeconfirmations.partials.future_groups', ['trade_confirmation' => $trade_confirmation])
