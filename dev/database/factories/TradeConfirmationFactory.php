...
$factory->define(App\Models\TradeConfirmations\TradeConfirmation::class, function (Faker $faker) {
    return [
		...
		'spot_price'					=> ( rand(0,10) > 4 ) ? randomFloat(2, 1, 99999999999 ) : NULL,
		'future_reference'				=> ( rand(0,10) > 4 ) ? randomFloat(2, 1, 99999999999 ) : NULL,
		'near_expiery_reference'		=> ( rand(0,10) > 4 ) ? randomFloat(2, 1, 99999999999 ) : NULL,
		'trade_confirmation_id'			=> NULL,
		'trade_confirmation_status_id'	=> factory( App\Models\Trade\TradeStatus::class )->create()->id,
		'market_id'						=> NULL,
		'stock_id'						=> NULL,
		'contracts'						=> randomFloat(2, 1, 99999999999 ),
		'puts'							=> randomFloat(2, 1, 99999999999 ),
		'calls'							=> randomFloat(2, 1, 99999999999 ),
		'delta'							=> randomFloat(2, 1, 99999999999 ),
		'gross_premiums'				=> randomFloat(2, 1, 99999999999 ),
		'net_premiums'					=> randomFloat(2, 1, 99999999999 ),
