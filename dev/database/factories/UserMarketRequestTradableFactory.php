...
$factory->define(App\Models\MarketRequest\UserMarketRequestTradable::class, function (Faker $faker) {
    ...
    return [
			...
			"market_id" => $isMarket ? factory(App\Models\StructureItems\Market::class)->create()->id : null,
			"stock_id" => !$isMarket ? factory(App\Models\StructureItems\Stock::class)->create()->id : null,
    ];
});
